...
FY_ID = "XS55083"  # Your fyers ID
APP_ID_TYPE = "2"  # Keep default as 2, It denotes web login
TOTP_KEY = "25RRUV4C536RK5BPZKVEVT5YWBJT4YVI"  # TOTP secret is generated when we enable 2Factor TOTP from myaccount portal
PIN = "1234"  # User pin for fyers account
APP_ID = "CDAAGPIZ8E"  # App ID from myapi dashboard is in the form appId-appType. Example - EGNI8CE27Q-100, In this code EGNI8CE27Q will be APP_ID and 100 will be the APP_TYPE
APP_SECRET="MRF6IPN10E"
