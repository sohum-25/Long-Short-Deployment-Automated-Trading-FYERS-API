...
FY_ID = "DK01731"  # Your fyers ID
APP_ID_TYPE = "2"  # Keep default as 2, It denotes web login
TOTP_KEY = "6ASMDEPJQAKCBQHPM66KH6BZE5Q4323L"  # TOTP secret is generated when we enable 2Factor TOTP from myaccount portal
PIN = "4321"  # User pin for fyers account
APP_ID = "R4NUGDSC7E"  # App ID from myapi dashboard is in the form appId-appType. Example - EGNI8CE27Q-100, In this code EGNI8CE27Q will be APP_ID and 100 will be the APP_TYPE
APP_SECRET="Q9YJ7QSN5X"
REDIRECT_URI = "https://www.google.com/"  # Redirect url from the app.
APP_TYPE = "100"
data_to_hash = f'{APP_ID}-{APP_TYPE}:{APP_SECRET}'
sha256_hash = hashlib.sha256()
sha256_hash.update(data_to_hash.encode())
hashed_data = sha256_hash.hexdigest()
APP_ID_HASH = hashed_data  # SHA-256 hash of appId-appType:appSecret
